<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding-5">
  <div class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-7 col-md-7-harf col-sm-8-harf col-xs-8">
        <input type="text" id="Type" class="form-control input-xs" maxlength="150" value="<?php echo $order->Type; ?>" disabled/>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-7 col-md-7-harf col-sm-8-harf col-xs-8">
        <input type="text" id="Project" class="form-control input-xs" maxlength="150" value="<?php echo $order->Project; ?>" disabled/>
      </div>
    </div>
  </div>
</div>
