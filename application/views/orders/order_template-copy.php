...
<tr id="row-{{no}}" data-no="{{no}}" class="rows">
  ...
  <input type="hidden" id="baseRef-{{no}}" value="" />
  <input type="hidden" id="baseEntry-{{no}}" value="" />
  <input type="hidden" id="baseLine-{{no}}" value="" />
  ...
  <input type="hidden" class="is-blank" id="is-blank-{{no}}" value="1" data-no="{{no}}"/>
...
<script id="childRow-template" type="text/x-handlebarsTemplate">
  <tr id="row-{{no}}" data-no="{{no}}" class="rows child">
    ...
    <input type="hidden" class="is-blank" id="is-blank-{{no}}" value="0" data-no="{{no}}"/>
...
<script id="import-row-template" type="text/x-handlebarsTemplate">
<tr id="row-{{no}}" data-no="{{no}}" class="rows">
  <input type="hidden" class="line-num" id="line-num-{{no}}" value="{{no}}" />
  <input type="hidden" id="baseRef-{{no}}" value="{{DocNum}}" />
  <input type="hidden" id="baseEntry-{{no}}" value="{{DocEntry}}" />
  <input type="hidden" id="baseLine-{{no}}" value="{{LineNum}}" />
  <input type="hidden" id="stdPrice-{{no}}" value="{{stdPrice}}" />
  <input type="hidden" id="cost-{{no}}" value="{{Cost}}" />
  <input type="hidden" id="price-{{no}}" value="{{stdPrice}}" />
  <input type="hidden" id="bCost-{{no}}" value="0" />
  <input type="hidden" id="sellPrice-{{no}}" value="{{SellPrice}}" />
  <input type="hidden" id="sysSellPrice-{{no}}" value="{{SellPrice}}" />
  <input type="hidden" id="disc-amount-{{no}}" value="{{discAmount}}"/>
  ...
  <td class=" text-center fix-img" scope="row"></td>
  <td class=" fix-item" scope="row">
    <input type="text" class="form-control input-xs item-code" data-id="{{no}}" id="itemCode-{{no}}" value="{{ItemCode}}"/>
  </td>
  <td class="">
    <input type="text" class="form-control input-xs item-name" data-id="{{no}}" id="itemName-{{no}}" value="{{ItemName}}"/>
  </td>

  <td class="">
    <input type="text" class="form-control input-xs item-detail" data-id="{{no}}" id="itemDetail-{{no}}" value="{{Description}}"/>
  </td>

  <td class="">
    <input type="number" class="form-control input-xs text-right line-qty {{father_uid}}" data-id="{{no}}" data-qty="{{Qty}}" id="line-qty-{{no}}" value="{{Qty}}"/>
  </td>
  <td class="">
    <select class="form-control input-xs" id="uom-{{no}}">
      <option value=""></option>
      <?php echo $select_uom; ?>
    </select>
  </td>
  ...
  <td class=" hide">
    <input type="text" class="form-control input-xs text-right" id="stdPrice-label-{{no}}" value="{{stdPriceLabel}}" />
  </td>
  ...
  <td class=" hide">
    <input type="text" class="form-control input-xs text-right" id="sys-disc-label-{{no}}"  value="{{sysDiscLabel}}" />
  </td>
