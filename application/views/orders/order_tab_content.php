        ...
        <tbody id="details-template">
          ...
          <?php if(!empty($details)) : ?>
              ...
              <tr id="row-<?php echo $no; ?>" data-no="<?php echo $no; ?>" class="rows <?php echo $bg; ?> <?php echo $error; ?> <?php echo $dummy; ?>">
                ...
                <input type="hidden" id="baseRef-<?php echo $no; ?>" value="<?php echo $rs->BaseRef; ?>" />
                <input type="hidden" id="baseEntry-<?php echo $no; ?>" value="<?php echo $rs->BaseEntry; ?>" />
                <input type="hidden" id="baseLine-<?php echo $no; ?>" value="<?php echo $rs->BaseLine; ?>" />
                ...
                <input type="hidden" class="is-blank" id="is-blank-<?php echo $no; ?>" value="0" data-no="<?php echo $no; ?>"/>
          ...
          <?php while($rows > 0) : ?>
            <tr id="row-<?php echo $no; ?>" data-no="<?php echo $no; ?>" class="rows">
              <input type="hidden" class="line-num" id="line-num-<?php echo $no; ?>" value="<?php echo $no; ?>" />
              <input type="hidden" id="baseRef-<?php echo $no; ?>" value="" />
              <input type="hidden" id="baseEntry-<?php echo $no; ?>" value="" />
              <input type="hidden" id="baseLine-<?php echo $no; ?>" value="" />
              ...
              <input type="hidden" class="is-blank" id="is-blank-<?php echo $no; ?>" value="1" data-no="<?php echo $no; ?>"/>
