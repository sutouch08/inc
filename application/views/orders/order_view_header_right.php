<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding-5 last">
	<div class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-lg-8-harf col-md-8 col-sm-7 col-xs-12 control-label-xs no-padding-right">SQ No.</label>
			<div class="col-lg-3-harf col-md-4 col-sm-5 col-xs-12">
				<input type="text" class="form-control input-xs" value="<?php echo $order->SQNO; ?>" disabled/>
			</div>
		</div>
