...
<?php $this->load->view('orders/view_style_sheet'); ?>
...
<?php $this->load->view('orders/order_view_header'); ?>
<?php $this->load->view('orders/order_view_detail'); ?>
<?php $this->load->view('orders/order_view_footer'); ?>
<?php $this->load->view('orders/order_logs_modal'); ?>
<?php $this->load->view('orders/reject_modal'); ?>
...
<script src="<?php echo base_url(); ?>scripts/orders/order_view.js?v=<?php echo date('YmdH'); ?>"></script>
