...
<form id="addForm" method="post" action="<?php echo $this->home; ?>/add">
	...
	<input type="hidden" id="max_amount" value="<?php echo getConfig('AMOUNT_TO_APPROVE_SO'); ?>" />
	<input type="hidden" id="max_discount" value="<?php echo getConfig('DISCOUNT_TO_APPROVE_SO'); ?>" />
</form>

<?php $this->load->view('orders/order_ship_to_modal'); ?>
<?php $this->load->view('orders/order_bill_to_modal'); ?>
<?php $this->load->view('orders/search_quotation_modal'); ?>
...
<script src="<?php echo base_url(); ?>scripts/orders/order_import_sq.js?v=<?php echo date('YmdH'); ?>"></script>
