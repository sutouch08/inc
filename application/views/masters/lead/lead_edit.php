	...
	<div class="col-sm-12 padding-5">
		<div class="tab-content" style="min-height:600px;">
			...
			<div class="tab-pane fade" id="contactTab">
				<?php $this->load->view('masters/lead/edit_contact_tab'); ?>
			</div>
			<div class="tab-pane fade" id="addressTab">
				<?php $this->load->view('masters/lead/edit_address_tab'); ?>
			</div>
			<div class="tab-pane fade" id="paymentTab">
				<?php $this->load->view('masters/lead/edit_payment_tab'); ?>
			</div>
			<div class="tab-pane fade" id="accountTab">
				<?php $this->load->view('masters/lead/edit_accounting_tab'); ?>
			</div>
			<div class="tab-pane fade" id="propertiesTab">
				<?php $this->load->view('masters/lead/edit_properties_tab'); ?>
			</div>
			<div class="tab-pane fade" id="remarkTab">
				<?php $this->load->view('masters/lead/edit_remark_tab'); ?>
			</div>
		</div>
	</div>
