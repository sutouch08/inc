...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-6 padding-5">
      ...
      <?php if($this->pm->can_add) : ?>
        <button type="button" class="btn btn-sm btn-success" onclick="goAdd()"><i class="fa fa-plus"></i> Add</button>
      <?php endif; ?>
      </p>
    </div>
</div><!-- End Row -->
...
<?php $this->load->view('masters/lead/lead_preview'); ?>
...
<script src="<?php echo base_url(); ?>scripts/lead/lead.js"></script>
