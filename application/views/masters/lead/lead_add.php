...
<div class="row">
	...
	<div class="col-sm-3 col-xs-6 padding-5">
		<label>Owner</label>
		<input type="text" class="form-control input-sm" name="ownerName" id="ownerName" value="<?php echo $owner_name; ?>">
		<input type="hidden" name="ownerCode" id="ownerCode" value="<?php echo $this->_user->emp_id; ?>">
	</div>
</div> <!-- row -->
	...
	<div class="col-sm-12 padding-5">
		<div class="tab-content" style="min-height:600px;">
			<div class="tab-pane fade active in" id="generalTab">
				<?php $this->load->view('masters/lead/add_general_tab'); ?>
			</div>
			<div class="tab-pane fade" id="contactTab">
				<?php $this->load->view('masters/lead/add_contact_tab'); ?>
			</div>
			<div class="tab-pane fade" id="addressTab">
				<?php $this->load->view('masters/lead/add_address_tab'); ?>
			</div>
			<div class="tab-pane fade" id="paymentTab">
				<?php $this->load->view('masters/lead/add_payment_tab'); ?>
			</div>
			<div class="tab-pane fade" id="accountTab">
				<?php $this->load->view('masters/lead/add_accounting_tab'); ?>
			</div>
			<div class="tab-pane fade" id="propertiesTab">
				<?php $this->load->view('masters/lead/add_properties_tab'); ?>
			</div>
			<div class="tab-pane fade" id="remarkTab">
				<?php $this->load->view('masters/lead/add_remark_tab'); ?>
			</div>
		</div>
	</div>
...
<script src="<?php echo base_url(); ?>scripts/lead/lead.js?v=<?php echo date('Ymd'); ?>"></script>
