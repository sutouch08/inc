...
<form class="form-horizontal" id="addForm" method="post">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="code" id="code" class="width-100" max-length="20" value="<?php echo $code; ?>" required />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" name="name" id="name" class="width-100" max-length="100" value="<?php echo $name; ?>" required />
    </div>
