...
<form class="form-horizontal" id="addForm" method="post">
  <div class="form-group">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<input type="text" class="width-100" value="<?php echo $name; ?>" disabled />
    </div>
    <div class="help-block col-xs-12 col-sm-reset inline red" id="name-error"></div>
  </div>

	<div class="form-group">
    <label for="default" class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label no-padding-right">Default</label>
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
			<label style="padding-top:5px; padding-left:10px;">
				<input name="default" id="default" class="ace" type="checkbox" value="1" <?php echo is_checked($is_default,1); ?> />
				<span class="lbl"></span>
			</label>
    </div>
  </div>
